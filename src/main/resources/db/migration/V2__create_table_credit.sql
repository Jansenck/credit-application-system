...
ALTER TABLE credit ADD CONSTRAINT uc_credit_creditvalue UNIQUE (credit_value);

ALTER TABLE credit ADD CONSTRAINT uc_credit_dayfirstinstallment UNIQUE (day_first_installment);
